  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Car Sharing Application: Driving Efficiency and Sustainability in Commuting. Share your journey, save on costs, and embrace eco-friendly travel."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Car Sharing Application: Driving Efficiency and Sustainability in Commuting. Share your journey, save on costs, and embrace eco-friendly travel.`}
            </Text>
            <Box
